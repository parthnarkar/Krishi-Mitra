...
const BulkBuyerPage = () => {
  ...
  const handleSubmitNegotiation = async () => {
    ...
    try {
      // Here we would typically make an API call to submit the negotiation
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-3xl font-bold text-primary mb-8">Bulk Purchase Negotiation</h1>
          
          {/* Product Details */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-text mb-4">Product Details</h2>
          ...
          {/* Quantity Slider */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-text mb-4">Select Quantity</h2>
          ...
          {/* Price Negotiation */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-text mb-4">Price Negotiation</h2>
          ...
          <div className="mb-8 p-4 bg-gray-50 rounded-lg">
            <h2 className="text-xl font-semibold text-text mb-4">Total Calculation</h2>
